          ...
          <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[70vh] flex items-end">
            ...
            <div className="relative z-10 p-md md:p-xl w-full max-w-4xl">
              ...
              <div className="flex flex-wrap gap-md">
                ...
                <Link href="/about">
                  <button className="liquid-glass text-white font-title-md text-title-md px-xl py-md rounded-full border-white/40 hover:bg-white/10 transition-colors w-full md:w-auto h-[52px] flex items-center justify-center" style={{ background: 'rgba(255,255,255,0.15)' }}>How it works</button>
                </Link>
              </div>
            </div>
          </div>
